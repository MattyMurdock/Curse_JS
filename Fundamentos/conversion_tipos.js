...
//ToNumber
alert("6" / "2"  ); //3, los string son convertidos a numeros.
let str ="123";
alert(typeof str); //string

let num = Number(str); //se convierte en 123
alert(typeof num); //number
let age = Number("Un texto que no es un numero");
alert(age); // NaN, conversion fallida.
...
// una suma o adicion tambien llamado pue
